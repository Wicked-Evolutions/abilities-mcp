 ...
 * The wp-mcp-adapter adds "type", "outputSchema", and "annotations" which aren't
 * valid for the 2024-11-05 protocol version Claude Code uses. Claude Code silently
 * drops the entire tool list when these are present.
 */
