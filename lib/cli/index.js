...
const COMMANDS = {
  ...
  'force-downgrade': () => require('./commands/force-downgrade'),
  'self-check': () => require('./commands/self-check'),
  'clear-keychain': () => require('./commands/clear-keychain'),
};
...
const HELP_TEXT = [
  ...
  '  clear-keychain <site_id>             Remove orphaned keychain entries for a site',
  '',
  'Global flags:',
